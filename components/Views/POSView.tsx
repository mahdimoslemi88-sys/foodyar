...
// Helper to get item icons based on category
...
export const POSView: React.FC = () => {
  ...
  // Memoize categories to avoid re-calculation on every render
  ...
  // Memoize total and item count to avoid re-calculating unless cart changes
